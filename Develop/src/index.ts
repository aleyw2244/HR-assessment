...
async function viewAllEmployees() {
    try {
        ...
        console.log('Please make sure the database is properly set up and you have the correct permissions.');
    }
}
...
async function viewAllRoles() {
    try {
        ...
        console.error('\nError viewing roles:', error?.message || 'Unknown error');
        console.log('Please make sure the database is properly set up and you have the correct permissions.');
    }
}
    ...
    try {
      ...
      const { title, salary, department_id } = await inquirer.prompt([
        ...
        { type: 'list', 
          ...
          choices: departments.rows.map((d: { name: any; id: any; }) => ({ name: d.name, value: d.id })) }
      ]);
...
async function viewAllDepartments() {
    try {
        ...
        console.error('\nError viewing departments:', error?.message || 'Unknown error');
        console.log('Please make sure the database is properly set up and you have the correct permissions.');
    }
}
